...
public class MessageBuilder {
     ...
     * @return this builder
     */
    public MessageBuilder addInteractiveText(String text, ClickEvent.Action clickAction, String clickValue, String hoverText) {
        if (lines.isEmpty()) newLine();
     ...
     * @return this builder
     */
    public MessageBuilder addHoverText(String text, String hoverText) {
        if (lines.isEmpty()) newLine();
        MessagePart part = new MessagePart(text != null ? text : "");
        if (hoverText != null && !hoverText.isEmpty()) {
            part.setHoverEvent(new HoverEvent(
