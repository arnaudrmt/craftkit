...
/**
 * Example of a simple confirmation GUI using InventoryBuilder.
 * This GUI displays a central option item, a cancel button, and a confirm button.
 */
public class GuiExample extends InventoryBuilder {
    ...
    public void createItems(Player player, Inventory inventory) {
        ...
        // 1. Main option item
        // ----------------------------
        ItemBuilder optionItem = new ItemBuilder(Material.SKULL_ITEM, itemTitle);
        ...
        // 2. Cancel button
        // ----------------------------
        ItemBuilder cancelItem = new ItemBuilder(Material.SKULL_ITEM, "§cAnnuler");
        ...
        // 3. Confirm button
        // ----------------------------
        ItemBuilder confirmItem = new ItemBuilder(Material.SKULL_ITEM, "§aConfirm");
